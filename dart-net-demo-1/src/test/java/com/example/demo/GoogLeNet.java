...
public class GoogLeNet extends ZooModel {
    ...
    public ComputationGraphConfiguration conf() {
        ...
        graph.addLayer("avg3", avgPool7x7(1), "5b-depthconcat1") // output: 1x1x1024
                        .addLayer("fc1", fullyConnected(50176, 1024, 0.4), "avg3") // output: 1x1x1024
                        ...
                        .setOutputs("output").backprop(true).pretrain(false).setInputTypes(InputType.convolutional(448, 448, 3));
